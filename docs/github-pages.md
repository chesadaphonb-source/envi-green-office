...
เว็บใหม่เผยแพร่แล้วเมื่อ 22 กันยายน 2569 ที่ **https://chesadaphonb-source.github.io/envi-green-office/** โดยตั้ง Source เป็น GitHub Actions และเชื่อมสารบัญเรียบร้อยแล้ว เว็บ Apps Script เดิมยังเก็บไว้ใช้งานระหว่างการย้าย ขั้นตอนตั้งค่าด้านล่างใช้สำหรับดูแลระบบหรือเชื่อมโปรเจกต์ใหม่

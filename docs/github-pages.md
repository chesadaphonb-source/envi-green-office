...
การดึงข้อมูลมีเวลาสูงสุด 60 วินาที ขนาดสูงสุด 20 MiB และยอมรับเฉพาะ snapshot ที่สร้างไม่เกิน 48 ชั่วโมง หากดึง ตรวจข้อมูล หรือ build ไม่ผ่าน workflow จะไม่ deploy เว็บรุ่นก่อนยังอยู่ ส่วนสารบัญในเครื่องจะเขียนทับเมื่อดาวน์โหลดและตรวจสอบสำเร็จแล้วเท่านั้น
